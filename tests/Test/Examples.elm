...
import Date.Extra as Date exposing (Interval(..), atTime, calendarDate, local, noTime, offset, ordinalDate, utc, weekDate)
import Test exposing (Test, describe, test)
import Test.Utilities exposing (DateParts, equals, toParts, toTimeOffset, toUtc)
...
mathTests =
    describe "Math"
        [ let
            dec31 =
                Date.fromCalendarDate 1999 Dec 31
