...
- `fromCalendarDate` becomes `partsToPosix`
- `compare` no longer exists, but is trivial to implement
...
- [`ryannhg/date-format`](https://package.elm-lang.org/packages/ryannhg/date-format/latest/) (replaces `toFormattedString`)
